...
public class UserServiceTest {
  ...
  public void shouldThrowExceptionWhenCreatingUserThatAlreadyExists() {
    ...
    User existingUser =
        new User(1L, "Carlos", "Tejada", "carlostejada@gmail.com", "+503 1234 5678", null);
    when(userRepository.findByEmail("carlostejada@gmail.com"))
  ...
  public void shouldReturnAllUsers() {
    ...
    User user1 =
        new User(1L, "Carlos", "Tejada", "carlostejada@gmail.com ", "+503 1234 5678", null);
    User user2 =
        new User(2L, "Leonardo", "Lescano", "jane.doe@example.com", "+503 9876 5432", null);
